...
#Region "Camara"
    ...
    Private Sub Button_CapurarIntantanea_Click(sender As System.Object, e As System.EventArgs) Handles Button_CapurarIntantanea.Click
        Try
            webcam_0.Capturar(PictureBox_Camara, TextBox_NombreFoto.Text.Trim)
...
#End Region
    ...
    Private Sub Button_ObtenerPuertos_Click(sender As Object, e As EventArgs) Handles Button_ObtenerPuertos.Click
