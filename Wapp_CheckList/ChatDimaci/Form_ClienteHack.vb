...
Public Class Form_Matador
    ...
    Private Sub Form_ClienteTCP_Disposed(sender As Object, e As EventArgs) Handles MyBase.Disposed
        Try
    ...
    Private Sub Button_EnviarMsj_Click_Intento(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button_EnviarMsj.Click
        Try
            ...
            If CheckBox_Encriptar.Checked Then
                MensajeEncriptado = Class_Encriptar.encriptar128BitRijndael(TextBox_Mensaje.Text)
            Else
                MensajeEncriptado = TextBox_Mensaje.Text
            End If
            ...
            Dim BuferTamaño As Integer = CInt(TextBox_BuferTamaño.Text)  'clientSocket.SendBufferSize / 8
