...
Public Class Class_Json
    ...
    Friend Function File_list(ByVal Archivo As String) As List(Of Archivo_Trading)
        ...
        If File.Exists(Archivo) Then
            Dim tmpstream As StreamReader = File.OpenText(Archivo)
    ...
    Public Shared Function Parse(source As String) As XDocument
        ...
        Dim document = If(value IsNot Nothing, New XDocument(New XDeclaration("1.0", "iso-8859-15", "yes"), value), Nothing)
        Return document
    End Function
