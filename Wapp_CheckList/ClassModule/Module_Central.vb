...
#Region "Clientes"
    ...
    Friend Function TransferirCliente(ByVal ArchivoCliente As Class_Materiales.ClassArchivo_Materiales) As Boolean
        Dim tranferido As Boolean = False
    ...
    Friend Function TransferirClienteMod(ByVal ArchivoReparacion As Class_Materiales.ClassArchivo_Materiales) As Boolean
        Dim tranferido As Boolean = False
    ...
    Friend Function TransferirClienteEliminar(ByVal ArchivoCliente As Class_Materiales.ClassArchivo_Materiales) As Boolean
        Dim tranferido As Boolean = False
    ...
    Friend Function ImportarClienteNif(ByVal ArchivoCliente As Class_Materiales.ClassArchivo_Materiales) As Boolean
        Dim tranferido As Boolean = False

        'For Each f As Form In Application.OpenForms
        '    If f.Name = Form_ClienteEditar.Name Then
        '        Form_ClienteEditar.TransferirDatosClienteNif(ArchivoCliente)
        '        tranferido = True
        '    End If
        'Next
        'If tranferido = False Then
