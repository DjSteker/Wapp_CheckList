...
Namespace ApiRpcExample
    ...
    Friend Class Programa1

        Shared Sub MainPrograma1(ByVal args As String())
            ...
            Else
                ...
                ServicePointManager.ServerCertificateValidationCallback = New RemoteCertificateValidationCallback(AddressOf Programa1.RemoteCertificateValidation)
                ...
                Try
                    Programa1.PrintResult(request.Send(packetUri))
    ...
    Public Class Class_ApiRpcEjemplo
