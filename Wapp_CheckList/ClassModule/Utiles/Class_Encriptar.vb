...
Public Class Class_Encriptar
    ...
    Private Shared Contraseña As String = "clave_ajpdsoft"
...
#Region "Buena"
    ...
    Friend Shared Function encriptar128BitRijndael(ByVal textoEncriptar As String) As String
        ...
        Else
            ...
            Contraseña = Contraseña & Strings.StrDup(intRemaining, "X")
        End If
    ...
    Friend Shared Function desencriptar128BitRijndael(ByVal textoEncriptado As String) As String
