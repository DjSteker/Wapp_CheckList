...
Public Class Class_CerebrosXML



    Shared Archivo As String = "\Cerebros.xml"
    Event Modificacion()

#Region "Leer"

    Friend Shared Function ObtenerTodos() As List(Of ClassArchivo_Cerebro)
    ...
    Friend Shared Function ObtenerWhereId(ByVal Id As String) As ClassArchivo_Cerebro
    ...
    Friend Shared Function ObtenerWhereNombre(ByVal Nombre As String) As ClassArchivo_Cerebro
        Dim Rejistro As New ClassArchivo_Cerebro(0, "")
        Dim RutaXMLConfigPrintInt As String = Class_Configuraciones.RutaDatos_Obtener().ToString & Archivo
        Dim xmlDoc As New XmlDocument
        xmlDoc.Load(RutaXMLConfigPrintInt)
                ...
                If Nombre.ToString = Valor_Compara Then
                    ...
                    For IndiceCapas As Integer = 0 To RegistroCapas.ChildNodes.Count - 1
                        ...
                        For IndiceNeuronas As Integer = 0 To RegistroNeuronas.Count - 1 'CapaXml.ChildNodes.Count - 1
                            ...
                            Try
                                Try
                                    Dim assss As String = RegistroNeurona.SelectSingleNode("C_W").InnerText
                                ...
                                End Try
                                Try
                                    RegistroArchivo.BiasPrebio2 = RegistroNeurona.SelectSingleNode("C_BiasPrebio2").InnerText
                                Catch ex As Exception

                                End Try
                                Try
                                    RegistroArchivo.BiasPrebio3 = RegistroNeurona.SelectSingleNode("C_BiasPrebio3").InnerText
                                Catch ex As Exception
    ...
    Friend Shared Function ObtenerWhereNombre_V1(ByVal Nombre As String) As ClassArchivo_Cerebro
        Dim Rejistro As New ClassArchivo_Cerebro(0, "")
        Dim RutaXMLConfigPrintInt As String = Class_Configuraciones.RutaDatos_Obtener().ToString & Archivo
        Dim xmlDoc As New XmlDocument
        xmlDoc.Load(RutaXMLConfigPrintInt)
    ...
    Friend Shared Function ObtenerWhereNombre_V0(ByVal Nombre As String) As ClassArchivo_Cerebro
        Dim Rejistro As New ClassArchivo_Cerebro(0, "")
        Dim RutaXMLConfigPrintInt As String = Class_Configuraciones.RutaDatos_Obtener().ToString & Archivo
        Dim xmlDoc As New XmlDocument
        xmlDoc.Load(RutaXMLConfigPrintInt)
...
#End Region
    ...
    Friend Shared Function InsertarRejistro(ByVal Archivo_Envio As ClassArchivo_Cerebro)
    ...
    Friend Shared Function ModificarRejistro(ByVal Valor_Id As String, ByVal Columnas As ClassArchivo_Cerebro) As Boolean
