...
Namespace BaseDatos
    ...
    Friend Shared Function ObtenerColumnas(ByVal Tabla As String, ByVal Rejistro As Long) As ArrayList
        ...
        Dim BodyDb As XmlNode = Tabla1.Item(0)
            ...
            Dim RejistroNudo As XmlNodeList = BodyDb.ChildNodes
            '  For Each member As XmlNode In BodyDb

            For Each member1 As XmlNode In RejistroNudo.Item(Rejistro)
    ...
    Friend Shared Function ObtenerWhereContador(ByVal Id As String) As Archivo_Contadores
        ...
        Try
                For Each RejistroNudo As XmlNode In NudoTabla.ChildNodes

                    Dim ID_Compara As String = RejistroNudo.SelectSingleNode("NombreContador").InnerText
                    If Id = ID_Compara Then
                        Enviado.NombreContador = RejistroNudo.SelectSingleNode("NombreContador").InnerText
                        Enviado.Cuenta = RejistroNudo.SelectSingleNode("Cuenta").InnerText
                        Exit For
                    End If
                Next
            Catch ex As Exception
    ...
    Friend Shared Function ExisteId(ByVal Id As String) As Boolean
        ...
        Try
                For Each RejistroNudo As XmlNode In NudoTabla.ChildNodes
                    Dim Comparador As String = RejistroNudo.SelectSingleNode("NombreContador").InnerText
    ...
    Friend Shared Function ModificarRejistro(ByVal SelecContador As String, ByVal Cuenta As Long) As Boolean
        ...
        Try
            ...
            PARADA.Start()
            Do While PARADA.ElapsedMilliseconds < 250
